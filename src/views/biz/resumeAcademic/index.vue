  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','resumeAcademic:edit','resumeAcademic:del']" label="操作" width="150px" align="center">
...
<script>
import crudResumeAcademic from '@/api/biz/resumeAcademic'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'ResumeAcademic', url: 'api/resumeAcademic', sort: 'id,desc', crudMethod: { ...crudResumeAcademic }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'resumeAcademic:add'],
        edit: ['admin', 'resumeAcademic:edit'],
        del: ['admin', 'resumeAcademic:del']
      },
      rules: {
      }    }
  },
