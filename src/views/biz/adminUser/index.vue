  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','adminUser:edit','adminUser:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudAdminUser from '@/api/biz/adminUser'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'AdminUser', url: 'api/adminUser', sort: 'id,desc', crudMethod: { ...crudAdminUser }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'adminUser:add'],
        edit: ['admin', 'adminUser:edit'],
        del: ['admin', 'adminUser:del']
      },
      rules: {
        provider: [
