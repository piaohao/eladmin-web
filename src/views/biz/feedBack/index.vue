    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="allowContact">
            <el-input v-model="form.allowContact" style="width: 370px;" />
          </el-form-item>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="allowContact" label="allowContact" />
...
<script>
import crudFeedBack from '@/api/biz/feedBack'
...
const defaultForm = { id: null, studentUserId: null, type: null, content: null, mobile: null, images: null, allowContact: null, createdAt: null, updatedAt: null }
export default {
  name: 'FeedBack',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'FeedBack', url: 'api/feedBack', sort: 'id,desc', crudMethod: { ...crudFeedBack }})
  },
  data() {
    return {
      permission: {
