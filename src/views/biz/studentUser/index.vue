  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','studentUser:edit','studentUser:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudStudentUser from '@/api/biz/studentUser'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'StudentUser', url: 'api/studentUser', sort: 'id,desc', crudMethod: { ...crudStudentUser }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'studentUser:add'],
        edit: ['admin', 'studentUser:edit'],
        del: ['admin', 'studentUser:del']
      },
      rules: {
        provider: [
