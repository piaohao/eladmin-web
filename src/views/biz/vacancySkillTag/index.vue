...
<script>
import crudVacancySkillTag from '@/api/biz/vacancySkillTag'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'VacancySkillTag', url: 'api/vacancySkillTag', sort: 'id,desc', crudMethod: { ...crudVacancySkillTag }})
  },
  data() {
    return {
      permission: {
