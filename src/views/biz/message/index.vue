    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="消息类型,1系统公告，2职位消息，3交易消息" prop="type">
            <el-input v-model="form.type" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="消息内容">
            <el-input v-model="form.content" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="发送方式,1所有企业，2部分企业">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="type" label="消息类型,1系统公告，2职位消息，3交易消息" />
        <el-table-column prop="content" label="消息内容" />
        <el-table-column prop="delivery" label="发送方式,1所有企业，2部分企业" />
...
const defaultForm = { id: null, title: null, type: null, content: null, delivery: null, createdAt: null, updatedAt: null }
export default {
  name: 'Message',
  ...
  data() {
    return {
      ...
      rules: {
        type: [
          { required: true, message: '消息类型,1系统公告，2职位消息，3交易消息不能为空', trigger: 'blur' }
        ],
        createdAt: [
