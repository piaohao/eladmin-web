...
<script>
import crudApprenticeProjectApplicant from '@/api/ApprenticeProjectApplicant'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'apprentice_project_applicant', url: 'api/ApprenticeProjectApplicant', sort: 'id,desc', crudMethod: { ...crudApprenticeProjectApplicant }})
  },
  data() {
    return {
      permission: {
