...
<script>
import crudResumeIntention from '@/api/biz/resumeIntention'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'ResumeIntention', url: 'api/resumeIntention', sort: 'id,desc', crudMethod: { ...crudResumeIntention }})
  },
  data() {
    return {
      permission: {
