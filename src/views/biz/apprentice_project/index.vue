...
<script>
import crudApprenticeProject from '@/api/ApprenticeProject'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'apprentice_project', url: 'api/ApprenticeProject', sort: 'id,desc', crudMethod: { ...crudApprenticeProject }})
  },
  data() {
    return {
      permission: {
