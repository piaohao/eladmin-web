...
<script>
import crudVacancyBookmark from '@/api/VacancyBookmark'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'vacancy_bookmark', url: 'api/VacancyBookmark', sort: 'id,desc', crudMethod: { ...crudVacancyBookmark }})
  },
  data() {
    return {
      permission: {
