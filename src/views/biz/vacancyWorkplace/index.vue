...
<script>
import crudVacancyWorkplace from '@/api/biz/vacancyWorkplace'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'VacancyWorkplace', url: 'api/vacancyWorkplace', sort: 'id,desc', crudMethod: { ...crudVacancyWorkplace }})
  },
  data() {
    return {
      permission: {
