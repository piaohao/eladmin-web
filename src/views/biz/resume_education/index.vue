...
<script>
import crudResumeEducation from '@/api/ResumeEducation'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'resume_education', url: 'api/ResumeEducation', sort: 'id,desc', crudMethod: { ...crudResumeEducation }})
  },
  data() {
    return {
      permission: {
