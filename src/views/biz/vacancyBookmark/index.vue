  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','vacancyBookmark:edit','vacancyBookmark:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudVacancyBookmark from '@/api/biz/vacancyBookmark'
...
const defaultForm = { id: null, vacancyId: null, studentUserId: null, createdAt: null, updatedAt: null }
export default {
  name: 'VacancyBookmark',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'VacancyBookmark', url: 'api/vacancyBookmark', sort: 'id,desc', crudMethod: { ...crudVacancyBookmark }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'vacancyBookmark:add'],
        edit: ['admin', 'vacancyBookmark:edit'],
        del: ['admin', 'vacancyBookmark:del']
      },
      rules: {
        createdAt: [
