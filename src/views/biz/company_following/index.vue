...
<script>
import crudCompanyFollowing from '@/api/CompanyFollowing'
...
export default {
  ...
  cruds() {
    return CRUD({ title: 'company_following', url: 'api/CompanyFollowing', sort: 'id,desc', crudMethod: { ...crudCompanyFollowing }})
  },
  data() {
    return {
      permission: {
